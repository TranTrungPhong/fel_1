...
public class HomeActivity extends AppCompatActivity
	...
	private void showSignOutDialog() {
		new AlertDialog.Builder(this).setTitle(R.string.infor)
	...
	public void onBackPressed() {
		if (mToast == null)
			mToast = Toast
					.makeText(HomeActivity.this, R.string.press_back_again_to_exit, Toast.LENGTH_SHORT);
	...
	public void onPostExecute( String response ) {
		if (GET_TAG == LOADCATEGORY_TAG) {
			if (response == null) {
				...
				isCategoryLoad = true;
				Toast.makeText(HomeActivity.this, R.string.response_done, Toast.LENGTH_SHORT)
						.show();
				try {
			...
			if (response == null) {
				...
				if (!responseInvalid.equals("")) {
					Toast.makeText(HomeActivity.this, responseInvalid, Toast.LENGTH_SHORT)
							.show();

				} else {
					Toast.makeText(HomeActivity.this, R.string.error_sign_out, Toast.LENGTH_SHORT)
							.show();
				}
				mSharedPreferences = getSharedPreferences(Const.MY_PREFERENCE, Context.MODE_PRIVATE);
				SharedPreferences.Editor editor = mSharedPreferences.edit();
